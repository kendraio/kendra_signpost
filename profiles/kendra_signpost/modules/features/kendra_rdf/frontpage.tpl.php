...
<ol>
<li><?php print l('Login', 'user'); ?> using your Kendra Account</li>
...
<li><?php print l('Use a portable filter', 'portable-filter-demo'); ?> to search uploaded content using the mappings.</li>
